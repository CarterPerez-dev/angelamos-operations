...
import { useVideos, useCreateVideo, useDeleteVideo, useUpdateVideo } from '../hooks/useAnalytics'
...
export function DataInputPage() {
  ...
  const sortedVideos = data?.items.slice().sort((a, b) => a.rank - b.rank) || []
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.videosSection}>
        <h2 className={styles.sectionTitle}>Tracked Videos ({data?.total || 0})</h2>

...
class JobApplication(Base, UUIDMixin, TimestampMixin):
    ...
    __table_args__ = (
        sa.Index("idx_job_app_user",
                 "user_id"),
        sa.Index("idx_job_app_status",
                 "application_status"),
        sa.Index("idx_job_app_outcome",
                 "outcome"),
        sa.Index("idx_job_app_date_applied",
                 "date_applied"),
    )
    ...
    remote_type: Mapped[RemoteType] = mapped_column(
        SafeEnum(RemoteType,
                 unknown_value = RemoteType.UNKNOWN),
    ...
    application_status: Mapped[ApplicationStatus] = mapped_column(
        SafeEnum(
            ApplicationStatus,
            unknown_value = ApplicationStatus.UNKNOWN
        ),
    ...
    outcome: Mapped[Outcome] = mapped_column(
        SafeEnum(Outcome,
                 unknown_value = Outcome.UNKNOWN),
        default = Outcome.PENDING,
    )

    job_type: Mapped[JobType] = mapped_column(
        SafeEnum(JobType,
                 unknown_value = JobType.UNKNOWN),
        default = JobType.UNKNOWN,
    )
    experience_level: Mapped[ExperienceLevel] = mapped_column(
        SafeEnum(ExperienceLevel,
                 unknown_value = ExperienceLevel.UNKNOWN),
        default = ExperienceLevel.UNKNOWN,
    )
    priority: Mapped[Priority] = mapped_column(
        SafeEnum(Priority,
                 unknown_value = Priority.UNKNOWN),
